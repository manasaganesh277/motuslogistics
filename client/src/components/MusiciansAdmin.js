...
export default class MusiciansAdmin extends Component {
  ...
  handleAddMusician = async(id, event) => {
    ...
    try {
      ...
      this.setState({ newmusician: { "firstName": "", "lastName": "", "large": "" }});
    }catch(err) {
      console.log(err);
    }
  }
  ...
  onAddMusicianGenreChange = event => this.setState({ newmusician: { ...this.state.newmusician, "large": event.target.value } });
      ...
      <Fragment>
        <section className="section">
          <div className="container">
            <p className="subtitle is-5">Add and remove customers using the form below:</p>
            <br />
                  ...
                  <div className="field">
                    <div className="control">
                      <input 
                        ...
                        value={this.state.newmusician.large}
